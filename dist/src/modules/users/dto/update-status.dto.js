...
class UpdateStatusDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: true, type: () => Object }, reason: { required: false, type: () => String, maxLength: 255 } };
    }
}
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Reason recorded for audit purposes, e.g. offboarding.' }),
