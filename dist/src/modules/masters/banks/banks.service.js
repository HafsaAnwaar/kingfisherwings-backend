...
let BanksService = class BanksService extends base_master_service_1.BaseMasterService {
    constructor(prisma) {
        super(prisma);
        this.modelName = 'bank';
        this.searchFields = ['name', 'short_name', 'swift_code'];
        this.uniqueKeyLabel = 'bank';
    }
};
