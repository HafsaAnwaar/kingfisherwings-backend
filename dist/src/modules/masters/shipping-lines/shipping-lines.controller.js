...
exports.ShippingLinesController = void 0;
const openapi = require("@nestjs/swagger");
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const shipping_lines_service_1 = require("./shipping-lines.service");
const shipping_line_dto_1 = require("../dto/shipping-line.dto");
...
let ShippingLinesController = class ShippingLinesController {
    constructor(service) {
...
exports.ShippingLinesController = ShippingLinesController;
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)(masters_permission_constants_1.MASTERS_PERMISSIONS.VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'list shippinglines' }),
...
], ShippingLinesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)(masters_permission_constants_1.MASTERS_PERMISSIONS.VIEW),
    ...
    __metadata("design:returntype", void 0)
], ShippingLinesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, shipping_line_dto_1.CreateShippingLineDto]),
    __metadata("design:returntype", void 0)
], ShippingLinesController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, shipping_line_dto_1.UpdateShippingLineDto]),
    __metadata("design:returntype", void 0)
], ShippingLinesController.prototype, "update", null);
__decorate([
...
], ShippingLinesController.prototype, "remove", null);
exports.ShippingLinesController = ShippingLinesController = __decorate([
    (0, swagger_1.ApiTags)('Masters — ShippingLines'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard, permissions_guard_1.PermissionsGuard),
    (0, common_1.Controller)('masters/shipping-lines'),
    __metadata("design:paramtypes", [shipping_lines_service_1.ShippingLinesService])
], ShippingLinesController);
//# sourceMappingURL=shipping-lines.controller.js.map