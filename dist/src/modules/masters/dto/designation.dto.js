...
class CreateDesignationDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, minLength: 2, maxLength: 100 }, department_id: { required: false, type: () => String }, is_active: { required: false, type: () => Boolean } };
    }
}
exports.CreateDesignationDto = CreateDesignationDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Operations Executive' }),
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateDesignationDto.prototype, "department_id", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ default: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateDesignationDto.prototype, "is_active", void 0);
