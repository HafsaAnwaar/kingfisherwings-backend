...
exports.ChargeCodesController = void 0;
const openapi = require("@nestjs/swagger");
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const charge_codes_service_1 = require("./charge-codes.service");
const charge_code_dto_1 = require("../dto/charge-code.dto");
...
let ChargeCodesController = class ChargeCodesController {
    constructor(service) {
...
exports.ChargeCodesController = ChargeCodesController;
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)(masters_permission_constants_1.MASTERS_PERMISSIONS.VIEW),
    (0, swagger_1.ApiOperation)({ summary: 'list chargecodes' }),
...
], ChargeCodesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, permissions_decorator_1.RequirePermissions)(masters_permission_constants_1.MASTERS_PERMISSIONS.VIEW),
    ...
    __metadata("design:returntype", void 0)
], ChargeCodesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, charge_code_dto_1.CreateChargeCodeDto]),
    __metadata("design:returntype", void 0)
], ChargeCodesController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, charge_code_dto_1.UpdateChargeCodeDto]),
    __metadata("design:returntype", void 0)
], ChargeCodesController.prototype, "update", null);
__decorate([
...
], ChargeCodesController.prototype, "remove", null);
exports.ChargeCodesController = ChargeCodesController = __decorate([
    (0, swagger_1.ApiTags)('Masters — ChargeCodes'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(roles_guard_1.RolesGuard, permissions_guard_1.PermissionsGuard),
    (0, common_1.Controller)('masters/charge-codes'),
    __metadata("design:paramtypes", [charge_codes_service_1.ChargeCodesService])
], ChargeCodesController);
//# sourceMappingURL=charge-codes.controller.js.map