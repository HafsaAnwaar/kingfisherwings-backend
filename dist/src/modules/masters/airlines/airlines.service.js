...
let AirlinesService = class AirlinesService extends base_master_service_1.BaseMasterService {
    constructor(prisma) {
        super(prisma);
        this.modelName = 'airline';
        this.searchFields = ['name', 'iata_code', 'icao_code'];
        this.uniqueKeyLabel = 'IATA code';
    }
};
