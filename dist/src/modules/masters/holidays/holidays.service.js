...
let HolidaysService = class HolidaysService extends base_master_service_1.BaseMasterService {
    constructor(prisma) {
        super(prisma);
        this.modelName = 'holiday';
        this.searchFields = ['name', 'country_code'];
        this.uniqueKeyLabel = 'holiday date for this country';
        this.supportsIsActive = false;
    }
};
