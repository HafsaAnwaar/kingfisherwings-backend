...
export class WmsItemsController {
  ...
  list(@CurrentUser() user: CurrentUserType, @Query() query: ItemQueryDto) {
    return this.service.list(user, query);
  }

  @Post()
  @RequirePermissions(WMS_PERMISSIONS.MANAGE_ITEMS)
  create(@CurrentUser() user: CurrentUserType, @Body() dto: CreateWmsItemDto) {
