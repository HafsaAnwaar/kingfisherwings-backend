...
export class WmsGdoController {
  ...
  @ApiOperation({
    summary: "Download GDO / GDN PDF (Goods Dispatch Order)",
    description:
      "On-demand PDF for DRAFT, POSTED, or CANCELLED (CANCELLED includes watermark). GDN is the same outbound document as GDO. Requires wms.view.",
  })
  downloadPdf(
