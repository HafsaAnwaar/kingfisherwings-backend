...
export class CreatePartyPortalUserDto {
  ...
  @ApiPropertyOptional({
    description: 'If omitted, a temporary password is generated and returned once (unless invite_mode).',
  })
  @IsOptional()
  @IsString()
  @MinLength(8)
  ...
  @ApiPropertyOptional({ description: 'When true (default), send email if SMTP is configured.' })
  @IsOptional()
  @IsBoolean()
  send_email?: boolean;
