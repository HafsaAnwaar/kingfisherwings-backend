...
export class NvoccJobsController {
  ...
  @RequirePermissions(NVOCC_PERMISSIONS.MANAGE)
  @ApiOperation({ summary: 'Queue NVOCC carrier HBL original PDF and mark HBL_ISSUED' })
  hblOriginal(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
    @Param('id', ParseUUIDPipe) id: string,
    ...
    return this.documentsService.generateHblOriginal(tenantId, id, dto, actorId);
  }
  ...
  hblExpressRelease(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'HBL_EXPRESS_RELEASE', dto, actorId);
  }

  @Post(':id/documents/surrender-notice')
  @RequirePermissions(NVOCC_PERMISSIONS.MANAGE)
  @ApiOperation({ summary: 'Queue surrender notice PDF and mark HBL surrendered' })
  surrenderNotice(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
    @Param('id', ParseUUIDPipe) id: string,
    ...
    return this.documentsService.generateSurrenderNotice(tenantId, id, dto, actorId);
  }
  ...
  mbl(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'MBL', dto, actorId);
  }

  @Patch(':id/mbl-received')
  @RequirePermissions(NVOCC_PERMISSIONS.MANAGE)
  @ApiOperation({ summary: 'Record MBL received and mark MBL_RECEIVED milestone' })
  mblReceived(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
    @Param('id', ParseUUIDPipe) id: string,
  ...
  preCan(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'PRE_CAN', dto, actorId);
  }
  ...
  can(
    ...
    return this.documentsService.generateImportDocument(tenantId, id, 'CAN', dto, actorId);
  }
  ...
  deliveryOrder(
    ...
    return this.documentsService.generateImportDocument(tenantId, id, 'DELIVERY_ORDER', dto, actorId);
  }
  ...
  preAlertPdf(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'PRE_ALERT', dto, actorId);
  }
  ...
  bookingConfirmation(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'BOOKING_CONFIRMATION', dto, actorId);
  }
  ...
  stuffingReport(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'STUFFING_REPORT', dto, actorId);
  }
  ...
  cargoManifest(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'CARGO_MANIFEST', dto, actorId);
  }
  ...
  jobCard(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'JOB_CARD', dto, actorId);
  }
  ...
  jobPnl(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'JOB_PNL', dto, actorId);
  }
  ...
  proformaInvoice(
    ...
    return this.documentsService.generateDocument(tenantId, id, 'PROFORMA_INVOICE', dto, actorId);
  }
