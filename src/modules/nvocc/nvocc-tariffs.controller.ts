...
export class NvoccTariffsController {
  ...
  findAll(@CurrentUser('tenantId') tenantId: string, @Query() query: NvoccTariffQueryDto) {
  ...
  lookup(@CurrentUser('tenantId') tenantId: string, @Query() query: NvoccTariffLookupDto) {
