...
export class QueryUserDto {
  ...
  @ApiPropertyOptional({ default: USERS_CONSTANTS.DEFAULT_LIMIT, minimum: 1, maximum: USERS_CONSTANTS.MAX_LIMIT })
  @IsOptional()
  @Transform(({ value }) => Number(value))
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({ enum: USERS_CONSTANTS.SORTABLE_FIELDS, default: USERS_CONSTANTS.DEFAULT_SORT })
  @IsOptional()
  @IsIn(USERS_CONSTANTS.SORTABLE_FIELDS)
  sortBy: string = USERS_CONSTANTS.DEFAULT_SORT;

  @ApiPropertyOptional({ enum: ['asc', 'desc'], default: USERS_CONSTANTS.DEFAULT_ORDER })
  @IsOptional()
  @IsIn(['asc', 'desc'])
