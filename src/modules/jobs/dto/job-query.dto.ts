...
export class JobQueryDto {
  ...
  @ApiPropertyOptional({
    format: "uuid",
    description: "Filter by job creator (created_by).",
  })
  @IsOptional()
  @IsUUID()
  created_by?: string;
  ...
  @ApiPropertyOptional({
    description: "Filter by customs entry number on air/sea detail tables.",
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description:
      "When true, only jobs with a customs entry number on their detail record.",
  })
  @IsOptional()
  @Transform(({ value }) => value === "true" || value === true)
  ...
  @ApiPropertyOptional({
    enum: ["etd", "eta", "atd", "ata"],
    description: "Date field for from_date/to_date range.",
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    format: "uuid",
    description: "Filter LAND jobs by trucker",
  })
  @IsOptional()
  @IsUUID()
  trucker_id?: string;
  ...
  @ApiPropertyOptional({
    description: "Filter COURIER jobs by tracking number",
  })
  @IsOptional()
  @IsString()
