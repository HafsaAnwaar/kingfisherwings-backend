...
export class GenerateJobDocumentDto {
  @ApiPropertyOptional({
    description: "Template layout variant (e.g. STANDARD, LAYOUT_A, LAYOUT_B)",
  })
  @IsOptional()
  @IsString()
  @MaxLength(50)
  ...
  @ApiPropertyOptional({
    default: false,
    description: "Generate as ORIGINAL (vs DRAFT watermark)",
  })
  @IsOptional()
  @IsBoolean()
  is_original?: boolean;
  ...
  @ApiPropertyOptional({
    description:
      "Use a specific BillOfLading record; otherwise latest matching type / job defaults",
  })
  @IsOptional()
  @IsUUID()
  bl_id?: string;
  ...
  @ApiPropertyOptional({
    default: 3,
    description: "Number of original BLs shown on header (1–3)",
  })
  @IsOptional()
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({
    description: "Original BL number being switched (SWITCH_BL)",
  })
  @IsOptional()
  @IsString()
  @MaxLength(50)
  ...
  @ApiPropertyOptional({
    format: "uuid",
    description: "Replacement consignee for SWITCH_BL",
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({
    format: "uuid",
    description: "Replacement notify party for SWITCH_BL",
  })
  @IsOptional()
  @IsUUID()
