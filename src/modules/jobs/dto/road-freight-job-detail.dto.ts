...
export class UpdateRoadFreightJobDetailDto {
...
export class AssignRoadFreightTruckerDto {
...
export class RecordRoadFreightPickupDto {
...
export class RecordRoadFreightBorderCrossingDto {
  @ApiPropertyOptional({
...
export class CreateRoadFreightPodDto {
  @ApiProperty()
  @IsDateString()
