...
export class LandService {
  ...
  private async getLandDetailOrThrow(
    ...
    if (!detail)
      throw new NotFoundException("Land job details not found for this job.");
    return detail;
  }
