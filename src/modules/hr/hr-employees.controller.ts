...
export class HrEmployeesController {
  ...
  @Get(':id/documents')
  @RequirePermissions(HR_PERMISSIONS.VIEW)
  listDocuments(@CurrentUser() user: CurrentUserType, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @Get(':id/dependents')
  @RequirePermissions(HR_PERMISSIONS.VIEW)
  listDependents(@CurrentUser() user: CurrentUserType, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @Get(':id/skills')
  @RequirePermissions(HR_PERMISSIONS.VIEW)
  listSkills(@CurrentUser() user: CurrentUserType, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @RequirePermissions(HR_PERMISSIONS.VIEW)
  listQualifications(@CurrentUser() user: CurrentUserType, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @RequirePermissions(HR_PERMISSIONS.VIEW)
  listHistory(@CurrentUser() user: CurrentUserType, @Param('id', ParseUUIDPipe) id: string) {
