...
class TrackQueryDto {
  @ApiPropertyOptional({
    example: "kingfisher",
    description: "Tenant slug. Optional if Host matches Tenant.domain.",
  })
  @IsOptional()
  @IsString()
  @Length(2, 100)
  ...
  @ApiProperty({
    example: "KFW-J-00042",
    description: "Job number, HAWB, MAWB, HBL, MBL, or booking #.",
  })
  @IsString()
  @Length(2, 100)
  ref!: string;
...
export class TrackController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns branding + endpoint hints for embedding a track widget on the tenant website.",
  })
  embed(
