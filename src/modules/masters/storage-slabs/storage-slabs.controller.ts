...
import { StorageSlabsService } from "./storage-slabs.service";
import { CreateStorageSlabDto, UpdateStorageSlabDto } from "../dto/storage-slab.dto";
...
@ApiTags("Masters — Storage Slabs")
@ApiBearerAuth()
@UseGuards(RolesGuard, PermissionsGuard)
@Controller("masters/storage-slabs")
export class StorageSlabsController {
  constructor(private readonly service: StorageSlabsService) {}

  @Get()
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: "list storage slabs" })
  findAll(
