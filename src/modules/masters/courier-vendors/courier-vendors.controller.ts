...
import { CourierVendorsService } from './courier-vendors.service';
import { CreateCourierVendorDto, UpdateCourierVendorDto } from '../dto/courier-vendor.dto';
...
@ApiTags('Masters — Courier Vendors')
@ApiBearerAuth()
@UseGuards(RolesGuard, PermissionsGuard)
@Controller('masters/courier-vendors')
export class CourierVendorsController {
  constructor(private readonly service: CourierVendorsService) {}

  @Get()
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: 'List courier vendors' })
  ...
  @Get(':id')
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: 'Get a courier vendor by id' })
  ...
  @ApiOperation({ summary: 'Create a courier vendor' })
  create(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
    @Body() dto: CreateCourierVendorDto,
  ) {
  ...
  @ApiOperation({ summary: 'Update a courier vendor' })
  update(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: UpdateCourierVendorDto,
  ) {
  ...
  @ApiOperation({ summary: 'Soft-delete a courier vendor' })
  async remove(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
    @Param('id', ParseUUIDPipe) id: string,
