...
@ApiTags('Masters — Truckers')
@ApiBearerAuth()
@UseGuards(RolesGuard, PermissionsGuard)
@Controller('masters/truckers')
export class TruckersController {
  constructor(private readonly service: TruckersService) {}

  @Get()
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: 'list truckers' })
