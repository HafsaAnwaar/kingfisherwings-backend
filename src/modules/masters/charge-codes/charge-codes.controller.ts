...
@ApiTags('Masters — ChargeCodes')
@ApiBearerAuth()
@UseGuards(RolesGuard, PermissionsGuard)
@Controller('masters/charge-codes')
export class ChargeCodesController {
  constructor(private readonly service: ChargeCodesService) {}

  @Get()
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: 'list chargecodes' })
