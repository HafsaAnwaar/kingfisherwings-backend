...
export class CreateCountryDto {
  ...
  @IsString()
  @Matches(/^[A-Z]{2}$/, {
    message: "iso_code must be 2 uppercase letters (e.g. AE)",
  })
  iso_code!: string;
  ...
  @IsString()
  @Matches(/^[A-Z]{3}$/, {
    message: "iso3_code must be 3 uppercase letters (e.g. ARE)",
  })
  iso3_code!: string;
  ...
  @ApiPropertyOptional({
    example: "+971",
    description: "Must match iso_code dialing prefix.",
  })
  @IsOptional()
