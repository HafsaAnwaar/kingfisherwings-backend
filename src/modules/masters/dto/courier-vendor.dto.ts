...
export class CreateCourierVendorDto {
  ...
  @ApiPropertyOptional({ example: 'https://www.dhl.com/en/express/tracking.html?AWB={tracking}' })
  @IsOptional()
  @IsString()
  @Length(1, 500)
...
export class UpdateCourierVendorDto extends PartialType(CreateCourierVendorDto) {}
