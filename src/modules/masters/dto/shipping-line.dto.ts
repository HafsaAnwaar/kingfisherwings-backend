...
export class CreateShippingLineDto {
  @ApiProperty({ example: 'MAEU', description: 'SCAC code (2–10 alphanumeric)' })
  @IsString()
  @Matches(/^[A-Z0-9]{2,10}$/, { message: 'scac_code must be 2–10 uppercase alphanumeric characters' })
  scac_code!: string;
  ...
  @IsOptional()
  @IsUrl({ require_protocol: true }, { message: 'website must be a valid URL with protocol (https://...)' })
  website?: string;
