...
import { RateBasesService } from "./rate-bases.service";
import { CreateRateBasisDto, UpdateRateBasisDto } from "../dto/rate-basis.dto";
...
@ApiTags("Masters — Rate Bases")
@ApiBearerAuth()
@UseGuards(RolesGuard, PermissionsGuard)
@Controller("masters/rate-bases")
export class RateBasesController {
  constructor(private readonly service: RateBasesService) {}

  @Get()
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: "list rate bases" })
  findAll(
