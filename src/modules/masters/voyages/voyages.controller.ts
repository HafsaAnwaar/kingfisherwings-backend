...
import { VoyageMastersService } from "./voyages.service";
import { CreateVoyageMasterDto, UpdateVoyageMasterDto } from "../dto/voyage-master.dto";
...
@ApiTags("Masters — Voyages")
@ApiBearerAuth()
@UseGuards(RolesGuard, PermissionsGuard)
@Controller("masters/voyages")
export class VoyageMastersController {
  constructor(private readonly service: VoyageMastersService) {}

  @Get()
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: "list voyages" })
  findAll(
  ...
  create(
    ...
    @Body() dto: CreateVoyageMasterDto,
  ) {
  ...
  update(
    ...
    @CurrentUser("id") actorId: string,
    @Param("id", ParseUUIDPipe) id: string,
    @Body() dto: UpdateVoyageMasterDto,
  ) {
