...
import { PackTypesService } from "./packs.service";
import { CreatePackTypeDto, UpdatePackTypeDto } from "../dto/pack-type.dto";
...
@ApiTags("Masters — Packs")
@ApiBearerAuth()
@UseGuards(RolesGuard, PermissionsGuard)
@Controller("masters/packs")
export class PackTypesController {
  constructor(private readonly service: PackTypesService) {}

  @Get()
  @RequirePermissions(MASTERS_PERMISSIONS.VIEW)
  @ApiOperation({ summary: "list packs" })
  findAll(
