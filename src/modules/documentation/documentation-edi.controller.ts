...
import { DocumentationEdiService, EdiListQueryDto } from './documentation-edi.service';
...
export class DocumentationEdiController {
  ...
  bayanMasterJobs(@CurrentUser('tenantId') tenantId: string, @Query() query: EdiListQueryDto) {
  ...
  async bayanSubmit(
    ...
    const generated = await this.ediService.generate(tenantId, 'BAYAN_MASTER', jobId, actorId);
  ...
  bayanAmend(
    ...
    return this.ediService.generate(tenantId, 'BAYAN_MASTER', jobId, actorId).then((sub) =>
      this.ediService.amend(tenantId, sub.id, actorId),
    );
  }

  @Get('bayan/shipments')
  @RequirePermissions(DOCUMENTATION_PERMISSIONS.EDI_READ)
  bayanHouseShipments(@CurrentUser('tenantId') tenantId: string, @Query() query: EdiListQueryDto) {
  ...
  @Get('ccn/jobs')
  @RequirePermissions(DOCUMENTATION_PERMISSIONS.EDI_READ)
  ccnJobs(@CurrentUser('tenantId') tenantId: string, @Query() query: EdiListQueryDto) {
  ...
  async ccnSubmit(
    ...
    const generated = await this.ediService.generate(tenantId, 'CCN_FWB', jobId, actorId);
    return this.ediService.submit(tenantId, generated.id, actorId);
  }

  @Get('eqo/dubai/jobs')
  @RequirePermissions(DOCUMENTATION_PERMISSIONS.EDI_READ)
  eqoDubai(@CurrentUser('tenantId') tenantId: string, @Query() query: EdiListQueryDto) {
  ...
  async eqoDubaiSubmit(
    ...
    const generated = await this.ediService.generate(tenantId, 'EQO_DUBAI', jobId, actorId);
    return this.ediService.submit(tenantId, generated.id, actorId);
  }

  @Get('eqo/oman/jobs')
  @RequirePermissions(DOCUMENTATION_PERMISSIONS.EDI_READ)
  eqoOman(@CurrentUser('tenantId') tenantId: string, @Query() query: EdiListQueryDto) {
  ...
  async eqoOmanSubmit(
    ...
    const generated = await this.ediService.generate(tenantId, 'EQO_OMAN', jobId, actorId);
    return this.ediService.submit(tenantId, generated.id, actorId);
  }

  @Get('ial/jobs')
  @RequirePermissions(DOCUMENTATION_PERMISSIONS.EDI_READ)
  ialJobs(@CurrentUser('tenantId') tenantId: string, @Query() query: EdiListQueryDto) {
  ...
  async ialSubmit(
    ...
    const generated = await this.ediService.generate(tenantId, 'IAL', jobId, actorId);
    return this.ediService.submit(tenantId, generated.id, actorId);
  }
}
