...
import { BoeDashboardQueryDto, CreateBoeRecordDto, UpdateBoeRecordDto } from './dto/documentation-boe.dto';
...
export class DocumentationBoeController {
  ...
  dashboard(@CurrentUser('tenantId') tenantId: string, @Query() query: BoeDashboardQueryDto) {
  ...
  pendingClaims(@CurrentUser('tenantId') tenantId: string, @Query() query: BoeDashboardQueryDto) {
