...
import { DocumentationCgmService, CgmVoyageDto } from './documentation-cgm.service';
...
export class DocumentationCgmController {
  ...
  findAll(@CurrentUser('tenantId') tenantId: string, @Query() query: DocumentationPaginationDto) {
