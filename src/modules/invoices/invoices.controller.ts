...
export class InvoicesController {
  ...
  @Get('reports/overdue')
  @RequirePermissions(INVOICES_PERMISSIONS.VIEW)
  @ApiOperation({ summary: 'Overdue customer invoices past due_date with outstanding balance' })
  ...
  @Post('from-job/:jobId')
  @RequirePermissions(INVOICES_PERMISSIONS.CREATE)
  @ApiOperation({ summary: 'Create draft invoice from uninvoiced billable job charges' })
  createFromJob(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
  ...
  async getPdfInfo(@CurrentUser('tenantId') tenantId: string, @Param('id', ParseUUIDPipe) id: string) {
