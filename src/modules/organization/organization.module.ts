...
@Module({
  ...
  controllers: [OrganizationController, BankAccountsController, NumberFormatsController],
  providers: [OrganizationService, BankAccountsService, NumberFormatsService, NumberGeneratorService],
