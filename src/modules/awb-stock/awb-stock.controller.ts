...
export class AwbStockController {
  ...
  listBatches(@CurrentUser('tenantId') tenantId: string, @Query() query: AwbStockQueryDto) {
  ...
  listAllocations(@CurrentUser('tenantId') tenantId: string, @Query() query: AwbStockQueryDto) {
  ...
  getBatch(@CurrentUser('tenantId') tenantId: string, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @ApiOperation({ summary: 'Allocate the next AWB number from a batch to a job' })
  allocate(
    @CurrentUser('tenantId') tenantId: string,
    @CurrentUser('id') actorId: string,
    @Param('id', ParseUUIDPipe) id: string,
