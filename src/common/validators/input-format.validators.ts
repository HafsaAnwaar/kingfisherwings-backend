...
export function IsIata2Code(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(IATA_2, {
      message: "must be a 2-character IATA code (A–Z / 0–9)",
      ...validationOptions,
    }),
  );
}
...
export function IsIata3Code(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(IATA_3, {
      message: "must be a 3-letter IATA code (A–Z)",
      ...validationOptions,
    }),
  );
}
...
export function IsIcao3Code(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(ICAO_3, {
      message: "must be a 3-letter ICAO code (A–Z)",
      ...validationOptions,
    }),
  );
}
...
export function IsIcao4Code(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(ICAO_4, {
      message: "must be a 4-letter ICAO code (A–Z)",
      ...validationOptions,
    }),
  );
}
...
export function IsUnLocode(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(UN_LOCODE, {
      message: "un_locode must look like AEJEA (UN/LOCODE)",
      ...validationOptions,
    }),
  );
}
...
export function IsImoNumber(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(IMO, {
      message: "imo_number must be a 7-digit IMO number",
      ...validationOptions,
    }),
  );
}
...
export function IsSwiftCode(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(SWIFT, {
      message: "swift_code must be a valid SWIFT/BIC (8 or 11 chars)",
      ...validationOptions,
    }),
  );
}
...
export function IsDialCode(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(DIAL_CODE, {
      message: "dial_code must look like +971",
      ...validationOptions,
    }),
  );
}
...
export function IsAwbPrefix(validationOptions?: ValidationOptions) {
  return applyDecorators(
    Matches(AWB_PREFIX, {
      message: "prefix_code must be a 3-digit AWB prefix",
      ...validationOptions,
    }),
  );
}
